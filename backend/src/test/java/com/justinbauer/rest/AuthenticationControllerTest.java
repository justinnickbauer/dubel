...
import com.justinbauer.common.TimeProvider;
import com.justinbauer.model.Authority;
import com.justinbauer.model.User;
import com.justinbauer.model.UserRoleName;
import com.justinbauer.security.DeviceDummy;
import com.justinbauer.security.TokenHelper;
import com.justinbauer.service.impl.CustomUserDetailsService;
...
public class AuthenticationControllerTest {
	...
	public void shouldGetEmptyTokenStateWhenGivenValidOldToken() throws Exception {
		...
		this.mvc.perform(post("/auth/refresh")
				...
				.andExpect(content().json("{access_token:null}"));
	}
	...
	public void shouldRefreshNotExpiredWebToken() throws Exception {
		...
		this.mvc.perform(post("/auth/refresh")
				...
				.andExpect(content().json("{access_token:" + refreshedToken + "}"));
	}
